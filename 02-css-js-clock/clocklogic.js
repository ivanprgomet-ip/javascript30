...
var HourHand = document.querySelector("#hour-hand");
        ...
        function UpdateClockHands() {
            ...
            var degreesPerSecond = ((currentSecond / 60) * 360)+90;//why +90? to offset hand to the default degree 
            ...
            var degreesPerMinute = ((currentMinute/60)*360)+90;//60/60=1 * 360 
            ...
            var degreesPerHour = ((currentHour/12)*360)+90;
            ...
            if(currentSecond == 0){
                ...
                secondHand.style.transition = "all 0.05s cubic-bezier(0.34,-1.15, 0, 1.98)";
                minuteHand.style.transition = "all 0.05s cubic-bezier(0.34,-1.15, 0, 1.98)";
                HourHand.style.transition = "all 0.05s cubic-bezier(0.34,-1.15, 0, 1.98)";
            }
        }